...
const Projects = async () => {
  ...
  return (
    ...
    {data.map((project) => (
        <div key={project.id} className="p-4 w-full border-2 border-solid border-blue-200 rounded-xl hover:border-blue-700 hover:-translate-y-2 hover:shadow-md hover:shadow-blue-500 max-w-sm md:max-w-md mt-10">
